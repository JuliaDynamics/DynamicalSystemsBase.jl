...
correct_state_type(::Val{true}, u0) = ismutable(u0) ? u0 : Array(u0)
correct_state_type(::Val{false}, u0) = SVector{length(u0)}(u0...)
correct_state_type(::Val{false}, u0::SVector) = u0
correct_state_type(::Val{false}, u0::Number) = u0
