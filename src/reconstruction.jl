...
"""
```julia
MDReconstruction(tr::SizedAray{A, B}, D, τ)
MDReconstruction(tr::AbstractDataset{B}, D, τ)
```
Create a multi-dimensional reconstruction using
...
"(D=$(D), τ=$(τ)) - delay coordinates $(B)DReconstruction"
